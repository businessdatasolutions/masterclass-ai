...
3.  **Van mockup naar prototype (30 minuten)**
    ...
    -   Ga naar een AI-tool ([Claude](https://claude.ai/){target="_blank"}, [ChatGPT 4o met Canvas](https://chat.openai.com/){target="_blank"}, [Gemini](https://www.google.com/){target="_blank"} of [Lovable](https://lovable.dev/){target="_blank"}).\
