...
2.  **Station 1: Explore (15 minuten)**
    ...
    -   **Start met jullie strategische analogie** uit de ochtend-sessie:
        -   Welke strategische keuze hebben jullie gemaakt?\
        -   Welke causale mechanismen zijn relevant voor AI-implementatie?\
    -   Identificeer 2-3 AI-kansen (use-cases) die **aansluiten bij jullie analogie**. Denk aan gebruik van data, klantbehoeften of markttrends.\
    -   Noteer kort de businesswaarden en beoogde impact: *Hoe ondersteunt AI de strategische logica uit jullie analogie?*
